 ...
 */
public interface ISupervisedDataSource<X, Y, I extends ILabeledInstance<Y> & IFeatureInstance<X>> extends IDataSource<X, I> {

	/**
	 * @return The list of attribute types which describe the labeling of an instance.
	 */
	public List<IAttributeType> getLabelTypes();

	/**
	 * @return The number of labels of an instance.
	 */
